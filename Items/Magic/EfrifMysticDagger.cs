...
{
    public class EfrifMysticDagger : ModItem 
    {
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Efrif Mystic Dagger");
			Tooltip.SetDefault("Shoots out a lost mystical dagger impaling enemies");
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<EfrifDagger>(); 
