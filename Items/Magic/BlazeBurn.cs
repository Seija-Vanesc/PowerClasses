...
{
    public class BlazeBurn : ModItem 
    {
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Blaze Burn");
			Tooltip.SetDefault("Shoots orbs of fire to burn enemies");
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<BurnSphere>(); 
