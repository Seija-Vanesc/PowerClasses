...
using PowerClasses.Items.Material;

namespace PowerClasses.Items.Material
{
	public class CursedEfrifShard : ModItem
	{
		public override void SetStaticDefaults()
		{
			//DisplayName.SetDefault("Soul of Efrif");
			Tooltip.SetDefault("A shard of an Efrif's heart that retained part of it's soul");
